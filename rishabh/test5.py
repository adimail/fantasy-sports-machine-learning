...
batter_weight = 1.0
bowler_weight = 1.0
allrounder_weight = 1.2  # Boost for all-rounders relative to the average
...
def calculate_score(row):
    ...
    if role == "batter":
        ...
        # Use the average of Batting and Bowling Form to give a middle-ground score.
...
def optimize_team(team1, team2, total_players=11):
    ...
    Returns:
        A DataFrame of selected players with their computed Score and assigned team role (Captain, Vice Captain, etc.).
    """
...
if __name__ == "__main__":
    # Example teams (adjust based on your dataset).
    team1 = "India"
    team2 = "Australia"
